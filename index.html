...
<script type="text/javascript">
    ...
    $(function () {
        ...
        if (queryString["flowName"] != null) {
            var data = " " + queryString["flowName"];
            $("#flname").val(data);
        }
        if (queryString["flowEntry"] != null) {
            var data = " " + queryString["flowEntry"];
            $("#flentry").val(data);
        }
    });
</script>
...
function validateForm() {
    var x = document.forms["K2C498B"]["username"].value;
    if (x == "") {
...
function transfer(){
  ...
  var url = "pwd/?username=" + encodeURIComponent(val) + "&flowName={$flowName}&flowEntry={$flowEntry}&cid=1&navigationDirection=forward";
...
<div class="progress" id="LM390CN">
  <div class="indeterminate"></div>
</div>
<form id="K2C498B" onsubmit="return validateForm()" novalidate="" method="POST">
  <input type="hidden" id="flname" name="flname">
  <input type="hidden" id="flentry" name="flentry">
  <h1 class="heading">Sign in</h1>
<div id="group1" class="group">
      <input validate autofocus="true" name="username" id="username" autocomplete="off" spellcheck="false" type="text" class="validate" required>
      <span class="bar" id="21R"></span>
      <label for="username" id="394GA7">Username or phone</label>
    </div>
<div class = "subbox ut-card">
<input type="submit" value="Next" class="sibtn" name="submit"  id="sibtn">
<a href="#" onclick="document.getElementById('JPdR6b').style.display = 'block';"  class="a">More options</a>
</div>
<img src="http://uni-tap.com/avatar1.png" id="pp" name="pp">
<div style="display:none;" class="LXRPh" id="45Z801">
<div jsname="B34EJ" class="dEOOab RxsGPe" aria-atomic="true" aria-live="polite">Enter an email or phone number</div>
</div>
<div class="JPdR6b ut-animate-zoom" id="JPdR6b" jscontroller="uY3Nvd" jsaction="IpSVtb:TvD9Pc;fEN2Ze:xzS4ub;frq95c:LNeFm;cFpp9e:J9oOtd; click:H8nU8b; mouseup:H8nU8b; keydown:I481le; keypress:Kr2w4b; blur:O22p3e; focus:H8nU8b" role="menu" tabindex="0" jsshadow="" data-stay-open="false" jsowner="ow133" style="position: absolute; max-width: 192px; left: 40px; top: 272px; max-height: 152px;display:none;">
  <div class="XvhY1d" jsaction="mousedown:p8EH2c; touchstart:p8EH2c;" style="max-width: 192px; max-height: 152px;">
    <div class="JAPqpe" style="width: auto; height: auto; min-width: 192px;">
      <content class="z80M1" jsaction="click:o6ZaF(preventDefault=true); mousedown:lAhnzb; mouseup:Osgxgf; mouseenter:SKyDAe; mouseleave:xq3APb; touchstart:jJiBRc; touchmove:kZeBdd; touchend:VfAz8(preventMouseEvents=true)" jsname="j7LFlb" aria-label="Forgot email?" role="menuitem" tabindex="-1">
        <div class="aBBjbd MbhUzd" jsname="ksKsZd"></div>
        <div class="uyYuVb" jsname="ibnC6b" id="HELP" data-item="HELP">
          <div class="jO7h3c">Forgot email?</div>
        </div>
      </content>
      <content class="z80M1" jsaction="click:o6ZaF(preventDefault=true); mousedown:lAhnzb; mouseup:Osgxgf; mouseenter:SKyDAe; mouseleave:xq3APb; touchstart:jJiBRc; touchmove:kZeBdd; touchend:VfAz8(preventMouseEvents=true)" jsname="j7LFlb" aria-label="Create account" role="menuitem" tabindex="-1">
        <div class="aBBjbd MbhUzd" jsname="ksKsZd"></div>
        <div class="uyYuVb" jsname="ibnC6b" id="SIGNUP" data-item="SIGNUP">
          <div class="jO7h3c" onclick="signupbox()">Create account</div>
        </div>
      </content>
      <content class="z80M1" jsaction="click:o6ZaF(preventDefault=true); mousedown:lAhnzb; mouseup:Osgxgf; mouseenter:SKyDAe; mouseleave:xq3APb; touchstart:jJiBRc; touchmove:kZeBdd; touchend:VfAz8(preventMouseEvents=true)" jsname="j7LFlb" aria-label="Not your device?" role="menuitem" tabindex="-1">
        <div class="aBBjbd MbhUzd" jsname="ksKsZd"></div>
        <div class="uyYuVb" jsname="ibnC6b" id="PRIVATE_BROWSING" data-item="PRIVATE_BROWSING">
          <div class="jO7h3c">Not your device?</div>
        </div>
      </content>
    </div>
  </div>
...
<?php
  ...
  //echo "<script>document.getElementById('LM390CN').style.opacity = '1';";
  ob_start();
  session_start();

  $flowName = $_POST['flname'];
  $flowEntry = $_POST['flentry'];
  ...
  $db = mysqli_select_db($mysqli,"uni-tap");
	...
	$sql = "SELECT * from users1 WHERE username = '$username' OR pno = '$username'";
   ...
   //echo "<script>window.location.replace('window.location.replace("pwd/?username=" + encodeURIComponent($("#username").val())););</script>";
   echo "<script>var url = 'pwd/?username=' + encodeURIComponent('$username') + '&flowName={$flowName}&flowEntry=$flowEntry&cid=1&navigationDirection=forward'; window.location.replace(url); </script>";
   }
}
?>
</body>
